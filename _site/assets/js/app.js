    ...
    viz()
    {
        ...
        var dataToPlot = {
            "plot-per-base-sequence-content": {
                ...
                title: "Base composition across Illumina read",
            ...
            "plot-per-base-sequence-quality": {
                ...
                title: "Illumina quality across the read",
                titleX: "Read Position",
                titleY: "Base Quality",
            ...
            "plot-dist-gc-content-per-read": {
                ...
                title: "Average Illumina GC content per read",
                titleX: "GC Content",
                titleY: "Counts",
                rangeY: undefined
            },
            "plot-dist-seq-length": {
                ...
                title: "Illumina read length distribution",
                titleX: "Read Length",
                titleY: "Counts",
                rangeY: undefined
            }
...
btnSample.addEventListener("click", function(){
    ...
    url.searchParams.set("url", "../assets/data/1RH_R1_001.fastq.gz");
